...
// configuration step. It creates a namespace called `bgfx_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", bgfx_test::cmake::project_name, bgfx_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", bgfx_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
